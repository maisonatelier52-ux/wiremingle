  ...
  return (
    <section className="mx-auto max-w-[94%] xl:max-w-[1360px] px-5 md:px-8 pt-4 pb-8 bg-white text-black font-sans">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
        ...
        <div className="flex flex-col gap-2 md:border-r border-neutral-200/50 md:pr-5 h-full">
          ...
          {col1Featured && (
            <article className="flex flex-col gap-2">
              ...
              <Link href={`/${col1Featured.category}/${col1Featured.slug}`}>
                <h3 className="text-[15px] font-semibold leading-snug tracking-tight text-neutral-900 hover:underline transition-colors duration-150 mt-1">
                  {col1Featured.title}
                </h3>
              </Link>
            </article>
