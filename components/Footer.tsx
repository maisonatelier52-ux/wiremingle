  ...
  return (
    <footer className="bg-black text-neutral-400 py-10 font-sans border-t border-neutral-900 w-full select-none">
      <div className="mx-auto max-w-[96%] xl:max-w-[1400px] px-4 md:px-6">
        ...
        {/* Bottom Row */}
        <div className="flex flex-col md:flex-row items-end justify-between gap-6 text-[12px] font-medium">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-neutral-400 max-w-[750px] text-center">
            ...
            <Link href="/ownership-funding" className="hover:text-white transition-colors">Ownership & Funding</Link>
            <Link href="/right-of-reply" className="hover:text-white transition-colors">Right of Reply Policy</Link>
            <Link href="/editorial-policy" className="hover:text-white transition-colors">Editorial Policy</Link>
            <Link href="/privacy-policy" className="hover:text-white transition-colors">Privacy Policy</Link>
            <Link href="/source-methodology" className="hover:text-white transition-colors">Source Methodology</Link>
            <Link href="/advertising-sponsored" className="hover:text-white transition-colors">Advertising & Sponsored Policy</Link>
          ...
          <div className="flex items-center gap-4 text-neutral-400">
            ...
            <div className="flex items-center gap-3">
              ...
              {/* Email / Envelope */}
              <Link
                href="mailto:contact@wiremingle.com"
                className="hover:text-white transition-colors"
                aria-label="Email"
              >
