      ...
      <div className="mx-auto max-w-[96%] xl:max-w-[1400px] px-4 md:px-6">
        ...
        <div className="hidden md:flex flex-row items-end justify-between gap-6 text-[12px] font-medium">
          ...
          <div className="flex items-center gap-4 text-neutral-400">
            ...
            <div className="flex items-center gap-3">              <Link href="https://www.facebook.com/profile.php?id=61586937479626" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Facebook">
                <svg className="h-4.5 w-4.5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                </svg>
              </Link>

              <Link href="https://www.instagram.com/wiremingle2026/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Instagram">
                <svg className="h-4.5 w-4.5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="https://www.reddit.com/user/wiremingle/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Reddit">
                <svg className="h-4.5 w-4.5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="https://substack.com/@wiremingle" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Substack">
                <svg className="h-4.5 w-4.5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22.539 8.242H1.46V5.406h21.08v2.836zM1.46 10.812V24L12 18.11 22.54 24V10.812H1.46zM22.539 0H1.46v2.836h21.08V0z" />
                </svg>
              </Link>

              <Link href="https://medium.com/@wiremingle" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity" aria-label="Medium">
        ...
        <div className="flex md:hidden flex-col gap-6 text-[12.5px] font-medium pt-2">
          ...
          <div className="flex items-center justify-center gap-4 text-neutral-400 pt-4 border-t border-neutral-900">
            ...
            <div className="flex items-center gap-3.5">
              <Link href="https://www.facebook.com/profile.php?id=61586937479626" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Facebook">
                <svg className="h-4.5 w-4.5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                </svg>
              </Link>
              ...
              <Link href="https://substack.com/@wiremingle" target="_blank" rel="noopener noreferrer" className="hover:text-[#FF6719] transition-colors" aria-label="Substack">
                <svg className="h-4.5 w-4.5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22.539 8.242H1.46V5.406h21.08v2.836zM1.46 10.812V24L12 18.11 22.54 24V10.812H1.46zM22.539 0H1.46v2.836h21.08V0z" />
                </svg>
              </Link>
