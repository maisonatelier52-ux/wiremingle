...
export default function RootLayout({
  ...
  const organizationSchema = {
    ...
    sameAs: [
      "https://www.facebook.com/profile.php?id=61586937479626",
      "https://www.instagram.com/wiremingle2026/",
      "https://www.reddit.com/user/wiremingle/",
      "https://substack.com/@wiremingle",
      "https://medium.com/@wiremingle",
    ],
